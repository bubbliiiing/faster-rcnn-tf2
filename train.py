...
if __name__ == "__main__":
    ...
    if True:
        ...
        for epoch in range(Init_Epoch,Freeze_Epoch):
            fit_one_epoch(model_rpn, model_all, epoch, epoch_size, epoch_size_val, gen, gen_val, Freeze_Epoch, callback)
            lr = lr*0.92
    ...
    if True:
        ...
        for epoch in range(Freeze_Epoch,Unfreeze_Epoch):
            fit_one_epoch(model_rpn, model_all, epoch, epoch_size, epoch_size_val, gen, gen_val, Unfreeze_Epoch, callback)
            lr = lr*0.92
            K.set_value(model_rpn.optimizer.lr, lr)
            K.set_value(model_all.optimizer.lr, lr)
